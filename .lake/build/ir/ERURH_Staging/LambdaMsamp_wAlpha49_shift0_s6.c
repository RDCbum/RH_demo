...
// Module: ERURH_Staging.LambdaMsamp_wAlpha49_shift0_s6
...
LEAN_EXPORT lean_object* initialize_ERURH__Staging_LambdaMsamp__wAlpha49__shift0__s6(uint8_t builtin, lean_object* w) {
lean_object * res;
