...
// Module: ERURH_Staging.LambdaMsamp_wAlpha49_shift0_s9
...
LEAN_EXPORT lean_object* initialize_ERURH__Staging_LambdaMsamp__wAlpha49__shift0__s9(uint8_t builtin, lean_object* w) {
lean_object * res;
