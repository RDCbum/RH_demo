...
// Module: ERURH_Staging.LambdaMsamp_wAlpha51_shift1_s1
...
LEAN_EXPORT lean_object* initialize_ERURH__Staging_LambdaMsamp__wAlpha51__shift1__s1(uint8_t builtin, lean_object* w) {
lean_object * res;
