...
// Module: ERURH_Staging.ZetaMsamp_wAlpha49_shift0_s8
...
LEAN_EXPORT lean_object* initialize_ERURH__Staging_ZetaMsamp__wAlpha49__shift0__s8(uint8_t builtin, lean_object* w) {
lean_object * res;
