...
// Module: ERURH_Staging.ZetaMsamp_wAlpha49_shift1_s7
...
LEAN_EXPORT lean_object* initialize_ERURH__Staging_ZetaMsamp__wAlpha49__shift1__s7(uint8_t builtin, lean_object* w) {
lean_object * res;
