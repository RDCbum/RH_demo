...
// Module: ERURH_Staging.ZetaMsamp_wAlpha50_shift0_s8
...
LEAN_EXPORT lean_object* initialize_ERURH__Staging_ZetaMsamp__wAlpha50__shift0__s8(uint8_t builtin, lean_object* w) {
lean_object * res;
