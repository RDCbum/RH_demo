...
// Module: ERURH_Staging.ZetaMsamp_wAlpha50_shift1_s9
...
LEAN_EXPORT lean_object* initialize_ERURH__Staging_ZetaMsamp__wAlpha50__shift1__s9(uint8_t builtin, lean_object* w) {
lean_object * res;
