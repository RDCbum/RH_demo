...
// Module: ERURH_Staging.ZetaMsamp_wAlpha51_shift0_s6
...
LEAN_EXPORT lean_object* initialize_ERURH__Staging_ZetaMsamp__wAlpha51__shift0__s6(uint8_t builtin, lean_object* w) {
lean_object * res;
