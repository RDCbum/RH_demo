...
3) the analytic lemmas stated in the paper (A1-from-supercritical-buchstab,
   buchstab-coefficient, and A2-from-ABC, together with the classical A/B/C packages).
