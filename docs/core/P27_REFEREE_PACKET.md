...
- `docs/core/FINAL_STATEMENTS.txt`
- `docs/core/FINAL_PRINT_AXIOMS_MASTER.txt`
- `docs/core/FINAL_PRINT_AXIOMS_UNCOND.txt`
- Capsule summary: `docs/core/FINAL_CAPSULE.md`
...
**Gate evidence**
- `docs/core/FINAL_GATE_FULL.txt` (latest full run)
